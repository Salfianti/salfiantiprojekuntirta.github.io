    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mahasiswa_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='fkip.mahasiswa')),
                ('tendik_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='fkip.tendik')),
            ],
        ),
    ]
